...
export default function Careers(){
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      ...
      <p className="text-slate-700 mb-4">We welcome talented professionals and students. To apply, send your CV and a cover letter to <a href="mailto:careers@augustlaw.house" className="text-indigo-600">careers@augustlaw.house</a>.</p>
